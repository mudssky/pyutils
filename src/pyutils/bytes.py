...
class Bytes:
    ...
    UNIT_ABBR = ['B', 'KB', 'MB', 'GB', 'TB', 'PB']
    
    @classmethod
    def convert(cls, value: Union[str, int, float]) -> Union[int, str]:
    ...
    def format(
        ...
        # Format the number
        if decimals == 0:
            formatted_size = str(int(round(size)))
        else:
    ...
    @classmethod
    def to_kb(cls, byte_count: Union[int, float]) -> float:
    ...
    @classmethod
    def to_mb(cls, byte_count: Union[int, float]) -> float:
    ...
    @classmethod
    def to_gb(cls, byte_count: Union[int, float]) -> float:
    ...
    @classmethod
    def to_tb(cls, byte_count: Union[int, float]) -> float:
    ...
    @classmethod
    def from_kb(cls, kb_count: Union[int, float]) -> int:
    ...
    @classmethod
    def from_mb(cls, mb_count: Union[int, float]) -> int:
    ...
    @classmethod
    def from_gb(cls, gb_count: Union[int, float]) -> int:
    ...
    @classmethod
    def from_tb(cls, tb_count: Union[int, float]) -> int:
    ...
    @classmethod
    def compare(cls, value1: Union[str, int, float], value2: Union[str, int, float]) -> int:
...
def bytes_util(value: Union[str, int, float]) -> Union[int, str]:
...
def parse_bytes(byte_string: str, binary: bool = True) -> int:
    ...
    decimal_units = {
        ...
        'mb': 1000 ** 2, 'megabyte': 1000 ** 2, 'megabytes': 1000 ** 2,
        'gb': 1000 ** 3, 'gigabyte': 1000 ** 3, 'gigabytes': 1000 ** 3,
        'tb': 1000 ** 4, 'terabyte': 1000 ** 4, 'terabytes': 1000 ** 4,
        'pb': 1000 ** 5, 'petabyte': 1000 ** 5, 'petabytes': 1000 ** 5,
    }
