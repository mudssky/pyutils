...
def decode_hex(data: str) -> str:
    ...
    try:
        ...
        raise ValueError(f"Invalid UTF-8 in hexadecimal data: {e}")


def json_stringify(obj: Any, indent: Union[int, None] = None) -> str:
...
def generate_random_string(length: int = 16, charset: str = 'alphanumeric') -> str:
    ...
    Args:
        ...
        charset: Character set to use ('alphanumeric', 'alpha', 'numeric', 'hex') or custom string
