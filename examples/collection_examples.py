...
def demonstrate_array_methods():
    ...
    print(
        f"includes(['apple', 'banana', 'cherry'], 'banana'): "
        f"{includes(fruits, 'banana')}"
    )
    print(
        f"includes(['apple', 'banana', 'cherry'], 'grape'): {includes(fruits, 'grape')}"
    )
...
def demonstrate_grouping():
    ...
    print(
        "group_by(['apple', 'banana', 'apricot', 'blueberry', 'cherry'], first_letter):"
    )
