...
class TestPackageIntegration:
    ...
    def test_complex_data_processing_pipeline(self):
        ...
        for person in processed:
            # Add computed fields
            object.set_value(person, 'display_name', 
                           string.capitalize(person['original_name']))
...
def sample_data():
    ...
    return {
        ...
        'products': [
            {'id': 101, 'name': 'Laptop Computer', 'price': 999.99, 'category': 'Electronics'},
            {'id': 102, 'name': 'Office Chair', 'price': 299.50, 'category': 'Furniture'},
            {'id': 103, 'name': 'Coffee Maker', 'price': 79.99, 'category': 'Appliances'}
        ]
    }
...
class TestRealWorldScenarios:
    ...
    def test_data_transformation_scenario(self, sample_data):
        ...
        alice = array.first(transformed_users, 
                          lambda u: object.get(u, 'name_slug') == 'alice-johnson')
    ...
    async def test_async_data_processing_scenario(self, sample_data):
        ...
        async def enrich_product(product):
            ...
            object.set_value(enriched, 'name_slug', 
                           string.slugify(object.get(product, 'name', '')))
            object.set_value(enriched, 'price_rounded', 
                           math.round_to_precision(object.get(product, 'price', 0), 0))
            object.set_value(enriched, 'category_snake', 
        ...
        laptop = array.first(enriched_products, 
                           lambda p: 'laptop' in object.get(p, 'name_slug', ''))
    ...
    def test_configuration_processing_scenario(self):
        ...
        config_lines = array.filter_list(lines, 
