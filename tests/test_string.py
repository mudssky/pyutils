...
from pyutils.string import (
    ...
    trim, reverse, fuzzy_match, parse_template, generate_uuid,
    generate_base62_code, get_file_ext, generate_merge_paths,
    word_count, capitalize, remove_prefix, remove_suffix,
...
class TestParseTemplate:
    ...
    def test_parse_template_multiple_vars(self):
        ...
        result = parse_template('{greeting} {name}!', {'greeting': 'Hello', 'name': 'World'})
        assert result == 'Hello World!'
...
class TestGenerateUuid:
    ...
    def test_generate_uuid_format(self):
        ...
        try:
            ...
            assert False, f"Generated UUID {result} is not valid"
